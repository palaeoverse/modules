...
Knowing how to debug code is an essential skill, whether one writes an analysis for a paper or develops an R package.
This module covers several tools that aim at making the debugging process easier.
