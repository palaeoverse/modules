...
Use the `fig-alt` option:

* for an external file: `![](path/to/file.png){fig-alt="A figure containing..."}`.

* in a chunk that produces a figure:

::: {style="font-size: 70%;"}
  ```{{r}}
  #| fig-alt: A plot that shows...
  plot(mtcars)
  ```
:::
...
## Change the font size for parts of the slide
